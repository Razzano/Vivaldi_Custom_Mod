...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  function showDialog(linkUrl, fromPanel) {
	...
	let webview = $c('webview');
	let divContainer = $c('div', {id: "dialog-container", className: "dialog-tab"});
    let divOptionContainer = $c('div', {id: 'dialog-options-container'});
    let progressBarContainer = $c('div', {id: 'progress-bar-container'});
  ...
  function setBackButtonContent(buttonBack) {
    let svg = $('.button-toolbar [name="Back"] svg');
    if (svg) {
  ...
  function setForwardButtonContent(forwardButton) {
    let svg = $('.button-toolbar [name="Forward"] svg');
    if (svg) {
