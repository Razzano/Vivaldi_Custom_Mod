...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  const OLD_PREFIX_V2 = 'srazzano_'; // Previous Version 2
  const UNPREFIXED_V1 = [
  ...
  const $$ = (sel, ctx = document) => ctx?.querySelectorAll(sel) ?? []; // Usage: const menu = $id('optionsMenu'); $$('.radio', menu).forEach(...);
  const $id = (id) => document.getElementById(id) ?? null; // Usage: $id('optionsButton');
  ...
  const Texts = {
	...
	label0: 'Enter a non-conflicting keyCode/combination and will\nalso hide toolbars ✓ in Toggle Toolbars Button below\n• Leave blank for no effect\n• Example: F9\n• Example: Ctrl+Alt+T',
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  function setOptionsMenu() {
    ...
    function Row1(id, labelText, spanText, tooltip, checked) {
	  ...
	  iconSpan.appendChild($c('svg', { id: `svg${id}`, className: 'svg' }));
    ...
    function Row20(id, labelText, spanText, tooltip, value) {
      const div = $c('div', { id: `div${id}`, title: tooltip });
      const iconSpan = $c('span', { id: `span${id}`, className: 'icon', title: spanText || Texts.div21 });
    ...
    optMenu.appendChild(Row12(0, null, Texts.span0a, Texts.label0, s.keyCodes));
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  function getCurrentTab() {
    ...
    const sitesToShift = ['https://www.youtube.com','https://forum.vivaldi.net'];
	const main = $id('main');
    const field = $('.UrlField', main);
    const img = $id('favImg');
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  function setToggleButton() {
	...
	const toggle = $c('button', {id: 'toggle-toolbars', className: 'ToolbarButton-Button custom-button  toggle-toolbars', title: Texts.toggleTooltip, onclick: () => { setToolbars(); reloadElements(); if ($id('optionsMenu')) onOptionsMenuPosition(s.positionMenu)}});
	try {
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
// Hides the tab bar and also toolbars checked in 'Toggle Toolbars Button ✓'
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  const browser = $id('browser');
  if (browser) {
	$id('input0').addEventListener('change', async (e) => {
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  function reloadElements() {
	...
	const togToolbars = $id('toggle-toolbars');
	const main = $id('main');
	const inner = $('.inner', main);
	try {
	  if (!cal) {
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  function showDialog(linkUrl, fromPanel) {
    ...
    progressBarContainer.style.margin = '27px 0px 0px 1%';
  ...
  function showWebviewOptions(webviewId, thisElement) {
    ...
    if (webview && $id(inputId) === null) {
      ...
      let buttonBack = createOptionsButton();
      let buttonForward = createOptionsButton();
      let buttonNewTab = createOptionsButton();
      let buttonBackgroundTab = createOptionsButton();
      let input = $c('input', {type: 'text'});
	  let buttonClose = createOptionsButton();
      setBackButtonContent(buttonBack);
	  buttonBack.style.margin = "-4px 0px 0px 0px";
	  buttonBack.title = "Go Back";
      buttonBack.addEventListener('click', function (event) {
        if (event.target === this || this.firstChild) webview.back();
      });
      setForwardButtonContent(buttonForward);
	  buttonForward.style.margin = "-4px 8px 0px 0px";
	  ...
	  buttonNewTab.style.margin = "-4px 0px 0px 0px";
	  ...
	  buttonBackgroundTab.style.margin = "-4px 0px 0px 14px";
      ...
      input.style.margin = '-8px 0px 0px 4px';
      input.style.padding = '0.25rem 0.5rem';
	  input.style.pointerEvents = "none";
	  input.style.textOverflow = 'ellipsis';
      input.style.width = '280px';
	  buttonClose.style.margin = "0px 0px 0px 0px";
  ...
  function createOptionsButton() {
	const btn = $c('button', {className: "dialog-button", style: {background: 'transparent', border: 'unset', margin: '0px 6px',},});
    return btn;
  }
