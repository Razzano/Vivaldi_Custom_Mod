(() => {
  ...
  // Usage: $q('#browser') or all $q('.radio', true).forEach(radio => radio.checked = false);
  ...
  const Icons = {
	...
	calendar:    'background: url(/style/icons/calendar.png) left center no-repeat; text-indent: 20px;',
    clear:       'background: url(/style/icons/delete.png) center center no-repeat',
	clock:       'background: url(/style/icons/clock.png) left center no-repeat; text-indent: 20px;',
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  function setOptionsMenu() {
    ...
    $q('#optionsMenu .checkbox', true).forEach(el => el.onclick = e => onOptionsMenuInput(e.target.id));
	$q('#optionsMenuClose').onclick = () => onOptions();
    ...
    $q('#input21').value = toolbarList  ?? '.mainbar, .bookmark-bar';
  ...
  async function onOptionsMenuInput(e) {
    ...
    switch (e) {
	  ...
	  case 'input22':
		...
		break;
	  default:
        console.warn('Unknown input value, input' + e);
        break;
  } }
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  function setToggleButton() {
    const tabs   = $q('#tabs-container'),
		  toggle = $c('button', {id: 'toggle-toolbars', className: 'ToolbarButton-Button custom-button  toggle-toolbars', title: Texts.toggleTooltip, onclick: () => {setToolbars(); reloadElements(); if ($q('div#optionsMenu')) onOptionsMenuPosition(positionOptionsMenu)}});
	try {
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  function reloadElements() {
    const cal         = $q('#calendar'),
	      optBtn      = $q('#optionsButton'),
		  optMenu     = $q('#optionsMenu'),
