...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  const Texts = {
	...
	input10: '20 - 1000 (Default: 1000 milliseconds)',
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  async function loadAllSettings() {
    ...
    try {
      ...
      s.favInterval = Number.isInteger(fRaw) ? Math.max(20, Math.min(1000, fRaw)) : 1000;
      const rRaw = Number(s.resizeDelay);
      s.resizeDelay = Number.isInteger(rRaw) ? Math.max(20, Math.min(1000, rRaw)) : 1000;
    ...
    const config = {
      ...
      'input10a': {
        save: () => {
          ...
          s.favInterval = Number.isInteger(val) ? Math.max(20, Math.min(1000, val)) : 1000;
      ...
      'input10b': {
        save: () => {
          const val = Number(el.value);
          s.resizeDelay = Number.isInteger(val) ? Math.max(20, Math.min(1000, val)) : 1000;
        ...
        if (img) {
          if (tab.favIconUrl) {
            ...
            if (tab.url.startsWith('vivaldi://')) {
              img.src = '/style/icons/vivaldi.png';
