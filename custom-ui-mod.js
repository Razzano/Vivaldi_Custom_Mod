...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  ...
  function setOptionsMenu() {
	...
	function Row22(id, labelText, spanText, tooltip, value) {
	  ...
	  div.appendChild($c('label', { id: `label${id}`, textContent: 'Options Menu Toggle' }));
	  div.appendChild($c('input', { id: `input${id}`, type: 'text', value: value }));
	  div.appendChild($c('div', { id: `div${id}b`, className: 'svg image' }));
      return div;
    }
	function Row23(id, labelText, spanText, tooltip, value) {
	  const div = $c('div', { id: `div${id}`, title: tooltip });
	  div.appendChild($c('label', { id: `label${id}`, textContent: 'Header Tabbar Toggle' }));
	  div.appendChild($c('input', { id: `input${id}`, type: 'text', value: value }));
	  div.appendChild($c('div', { id: `div${id}b`, className: 'svg image' }));
      return div;
    }
    ...
    optMenu.appendChild(Row12(0, null, Texts.span0a));
	optMenu.appendChild(Row22(23, null, Texts.span23, Texts.label0, s.keyCodes));
	optMenu.appendChild(Row23(24, null, Texts.span24, Texts.label0a, s.keyCodes2));
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
  function getHomeButton() {
    const button = $('button[title^="Homepage" i], button[title="Go to homepage" i]');
